...
namespace DuiLib
{
	...
	protected:
		...
		//把destStr属性中的数个数字提取出来, destRect为存放提出来的数组
		void FetchDestValue(const LPCTSTR destStr, RECT &destRect);

		//改变字符串dest 属性
		void UpdateDestValue(CDuiString &destStr, RECT &destRect);
